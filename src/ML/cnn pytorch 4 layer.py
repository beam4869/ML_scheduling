...
# df.to_excel('4 layer CNN total dataset validation loss and accuracy lr = 0.0003.xlsx', index=None)
df.to_excel('4 layer CNN total dataset no 2d points validation loss and accuracy lr = 0.0005.xlsx', index=None)

plt.figure(figsize=(8,6))
sns.heatmap(conf_matrix, annot=True, fmt="d", cmap="Blues", xticklabels=[0,1,2,3,4], yticklabels=[0,1,2,3,4])
plt.title(f'4 layers CNN Confusion Matrix Accuracy = {round(accuracy,4)}')
