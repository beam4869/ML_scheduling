...
df2 = pd.read_csv("/Users/hongxuan/Library/CloudStorage/GoogleDrive-hongxuan@umich.edu/My Drive/AA gourp/transfer learning/moving horizon scheduling_test/lstm_predicted_vs_true_results_updated.csv")
...
predicted_labels = df2["Predicted_200to500_updated_Label"].values[a:b]
...
# ==========================================================
# ting regions were found, so no tradeoff-length bar plot was generated.")
