...
# Figure 2 source data: objective metrics, per-step cost/emms, and the
# power-price / carbon-intensity profiles plotted in the bottom subplot
...
# Per-step prediction labels (useful for reproducing the grey-shaded regions)
labels_df = pd.DataFrame({
    "Time_h":          x_hours,
    "True_Label":      true_labels,
    "Predicted_Label": lstm_predicted,
})
...
excel_out = "cost_or_emms_true_classification_source_data.xlsx"
